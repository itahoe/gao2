...
static
void    ui_dspl_scr2_add_graph(         WM_HWIN                 hWin,
                                        int                     id )
{
        WM_HWIN         hItem;
        ...
        //hItem   =   GRAPH_CreateEx( x0, y0, sizeX, sizeY, hWin, UI_DSPL_WIN_STYLE, 0, GUI_ID_SCR2_GRAPH );
...
void    ui_dspl_scr2_cb(                        WM_MESSAGE *            pMsg )
{
        ...
        switch( pMsg->MsgId )
        {
                case WM_INIT_DIALOG:
                        ...
                        ui_dspl_scr2_add_graph( hItem, GUI_ID_SCR2_GRAPH );
...
WM_HWIN ui_dspl_scr2_init(              WM_CALLBACK *           cb )
{
        ...
        hItem   =       GRAPH_CreateEx( 0, 0, sizeX, sizeY, hWin, UI_DSPL_WIN_STYLE, 0, GUI_ID_SCR2_GRAPH );
