...
{
    //{ WINDOW_CreateIndirect,    "scr2",         GUI_ID_SCR1_WINDOW,           0,      0,    800,    480,      0,      0x0,    0 },
    { WINDOW_CreateIndirect,    "scr2",         GUI_ID_SCR1_WINDOW,         800,      0,    800,    480,      0,      0x0,    0 },
...
{
    //{ WINDOW_CreateIndirect,    "scr3",         GUI_ID_SCR2_WINDOW,         800,      0,    800,    480,      0,      0x0,    0 },
    { WINDOW_CreateIndirect,    "scr3",         GUI_ID_SCR2_WINDOW,         800,      0,    800,    480,      0,      0x0,    0 },
