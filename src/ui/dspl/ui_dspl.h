...
#define GUI_ID_SCR3_CHNL_TXT_A                  (GUI_ID_USER + 0x311)
#define GUI_ID_SCR3_CHNL_TXT_B                  (GUI_ID_USER + 0x312)
#define GUI_ID_SCR3_CHNL_TXT_C                  (GUI_ID_USER + 0x313)
#define GUI_ID_SCR3_CHNL_BTN_UP_A               (GUI_ID_USER + 0x314)
#define GUI_ID_SCR3_CHNL_BTN_DN_A               (GUI_ID_USER + 0x315)
#define GUI_ID_SCR3_CHNL_BTN_UP_B               (GUI_ID_USER + 0x316)
#define GUI_ID_SCR3_CHNL_BTN_DN_B               (GUI_ID_USER + 0x317)
#define GUI_ID_SCR3_CHNL_BTN_UP_C               (GUI_ID_USER + 0x318)
#define GUI_ID_SCR3_CHNL_BTN_DN_C               (GUI_ID_USER + 0x319)
