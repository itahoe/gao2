...
#define GUI_ID_SCR3_BUTTON_BACK                 (GUI_ID_USER + 0x310)

#define GUI_ID_SCR3_DATE_TXT_DAY                (GUI_ID_USER + 0x311)
#define GUI_ID_SCR3_DATE_TXT_MON                (GUI_ID_USER + 0x312)
#define GUI_ID_SCR3_DATE_TXT_YEAR               (GUI_ID_USER + 0x313)
#define GUI_ID_SCR3_DATE_BTN_YEAR_UP            (GUI_ID_USER + 0x314)
#define GUI_ID_SCR3_DATE_BTN_YEAR_DN            (GUI_ID_USER + 0x315)
#define GUI_ID_SCR3_DATE_BTN_MON_UP             (GUI_ID_USER + 0x316)
#define GUI_ID_SCR3_DATE_BTN_MON_DN             (GUI_ID_USER + 0x317)
#define GUI_ID_SCR3_DATE_BTN_DAY_UP             (GUI_ID_USER + 0x318)
#define GUI_ID_SCR3_DATE_BTN_DAY_DN             (GUI_ID_USER + 0x319)

#define GUI_ID_SCR3_TIME_TXT_HOUR               (GUI_ID_USER + 0x311)
#define GUI_ID_SCR3_TIME_TXT_MIN                (GUI_ID_USER + 0x312)
#define GUI_ID_SCR3_TIME_TXT_SEC                (GUI_ID_USER + 0x313)
#define GUI_ID_SCR3_TIME_BTN_HOUR_UP            (GUI_ID_USER + 0x314)
#define GUI_ID_SCR3_TIME_BTN_HOUR_DN            (GUI_ID_USER + 0x315)
#define GUI_ID_SCR3_TIME_BTN_MIN_UP             (GUI_ID_USER + 0x316)
#define GUI_ID_SCR3_TIME_BTN_MIN_DN             (GUI_ID_USER + 0x317)
#define GUI_ID_SCR3_TIME_BTN_SEC_UP             (GUI_ID_USER + 0x318)
#define GUI_ID_SCR3_TIME_BTN_SEC_DN             (GUI_ID_USER + 0x319)

#define GUI_ID_SCR3_CHNL_TXT_PHY                (GUI_ID_USER + 0x311)
#define GUI_ID_SCR3_CHNL_TXT_RATE               (GUI_ID_USER + 0x312)
#define GUI_ID_SCR3_CHNL_TXT_PROT               (GUI_ID_USER + 0x313)
#define GUI_ID_SCR3_CHNL_BTN_UP_PHY             (GUI_ID_USER + 0x314)
#define GUI_ID_SCR3_CHNL_BTN_DN_PHY             (GUI_ID_USER + 0x315)
#define GUI_ID_SCR3_CHNL_BTN_UP_RATE            (GUI_ID_USER + 0x316)
#define GUI_ID_SCR3_CHNL_BTN_DN_RATE            (GUI_ID_USER + 0x317)
#define GUI_ID_SCR3_CHNL_BTN_UP_PROT            (GUI_ID_USER + 0x318)
#define GUI_ID_SCR3_CHNL_BTN_DN_PROT            (GUI_ID_USER + 0x319)
